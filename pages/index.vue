        ...
        <div class="card mb-4 shadow-sm">
          ...
          <div class="card-body">
            ...
            <div class="d-flex justify-content-between align-items-center">
              <div class="btn-group">
                <nuxt-link :to="`/posts/${post.slug}`" class="btn btn-sm btn-outline-secondary">Read</nuxt-link>
              </div>
...
export default {
  ...
  head() {
    return {
      title: "Home page",
      meta: [
        { hid: "description", name: "description", content: "The blog is about interview preparation"},
        { hid: "keywords", name: "keywords", content: "interview, interview preparation, interview help, interview materials, tech interview"}
      ]
    }
  },
}
