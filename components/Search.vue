          ...
          <div class="carousel-item active" style="background-color: #343a40!important">
            <div class="carousel-caption d-none d-md-block">
              <form class="my-2 my-lg-0">
                <input name="q" type="text" class="form-control" placeholder="Search" aria-label="Search" v-model="q">
                <button class="btn btn-outline-success mt-3" @click.stop.prevent="searchPosts()">Search</button>
              </form>
            </div>
          </div>
        </div>
